<!-- 将此文件保存为: web/src/views/teacher/ExerciseStatsView.vue -->
<template>
  <ContentField>
            ...
            <tr v-for="(exercise, index) in exercises" :key="exercise.exerciseId">
                ...
                <div class="d-flex align-items-center">
                  <div class="progress flex-grow-1 me-2" style="height: 20px;">
                    <div class="progress-bar" 
                      :class="getCompletionColor(exercise.completionRate)"
                      role="progressbar" 
                      :style="{width: exercise.completionRate + '%'}"
                      :aria-valuenow="exercise.completionRate" 
                      aria-valuemin="0" 
                      aria-valuemax="100">
                    </div>
                  </div>
                  <span class="text-muted" style="min-width: 50px;">{{ exercise.completionRate }}%</span>
                </div>
              </td>
              ...
              <td>
                <div class="stars-display-small">
                  ...
                  <span class="ms-2 text-muted small">{{ exercise.avgScore }}</span>
                </div>
              </td>
            </tr>
          </tbody>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row text-center">
                ...
                <div class="col-md-3">
                  <div class="stat-item">
                    <h3 class="text-success">{{ overallCompletionRate }}%</h3>
                    <p class="text-muted mb-0">平均完成率</p>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="stat-item">
...
export default {
  ...
  computed: {
    overallCompletionRate() {
      ...
      const total = this.exercises.reduce((sum, e) => sum + e.completionRate, 0);
